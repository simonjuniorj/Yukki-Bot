...
module.exports = {name: "set-modlog",category: "admin",description: "Sends detailed info about the client",usage: "[command]",
    run: (client, message, args) => {
        ...
        db.set(`modlogChannel_${message.guild.id}`, channel.id)
    }
}